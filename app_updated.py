...
.logo{height:26px;display:flex;align-items:center;justify-content:center;border:1px solid #22335d;background:#0e1a35;border-radius:12px;padding:8px}
.logo .name{margin-top:6px;font-size:12px;color:#9fb2d9;text-align:center}
...
.socials{display:grid;grid-template-columns:repeat(6,1fr);gap:10px}
@media(max-width:920px){.socials{grid-template-columns:repeat(3,1fr)}}
.soc{display:grid;justify-items:center;gap:6px;padding:10px;border:1px solid #22335d;background:#0e1a35;border-radius:12px}
.soc img{height:22px;width:22px}
...
<section class="sec fade" id="exchanges">
  ...
  <div class="small" style="margin-top:8px;color:#b8c8e8">Logos auto-loaded from your app config.</div>
</section>
...
<section class="sec grid fade">
  ...
  <div class="box">
    ...
    <div class="socials">
      <a class="soc" target="_blank" rel="noopener" href="https://x.com/arbexascanner?s=21">
        <img alt="X" src="https://icons.duckduckgo.com/ip3/x.com.ico"><div class="name">X / Twitter</div>
      </a>
      <a class="soc" target="_blank" rel="noopener" href="https://www.youtube.com/@ArbexaProfitFinder">
        <img alt="YouTube" src="https://icons.duckduckgo.com/ip3/youtube.com.ico"><div class="name">YouTube</div>
      </a>
      <a class="soc" target="_blank" rel="noopener" href="https://www.tiktok.com/@arbexaprofitfinder">
        <img alt="TikTok" src="https://icons.duckduckgo.com/ip3/tiktok.com.ico"><div class="name">TikTok</div>
      </a>
      <a class="soc" target="_blank" rel="noopener" href="https://t.me/arbexaprofitfinderchannel">
        <img alt="Telegram" src="https://icons.duckduckgo.com/ip3/t.me.ico"><div class="name">Channel</div>
      </a>
      <a class="soc" target="_blank" rel="noopener" href="https://t.me/ArbexaProfitFinderSupport">
        <img alt="Telegram" src="https://icons.duckduckgo.com/ip3/t.me.ico"><div class="name">Support</div>
      </a>
      <a class="soc" target="_blank" rel="noopener" href="https://www.instagram.com/arbexaprofitfinder">
        <img alt="Instagram" src="https://icons.duckduckgo.com/ip3/instagram.com.ico"><div class="name">Instagram</div>
      </a>
    </div>
  </div>
</section>
...
<section class="sec fade" id="pricing">
  ...
  <div class="pricing">
    <div class="plan"><div class="t">Weekly</div><div class="p">$10</div><a class="btn" href="/login">Login</a></div>
    <div class="plan"><div class="t">Monthly</div><div class="p">$20</div><a class="btn" href="/login">Login</a></div>
    <div class="plan"><div class="t">3 Months</div><div class="p">$55</div><span class="small">-8%</span><a class="btn" href="/login">Login</a></div>
    <div class="plan"><div class="t">6 Months</div><div class="p">$100</div><span class="small">-16%</span><a class="btn" href="/login">Login</a></div>
    <div class="plan rec"><div class="t">Yearly</div><div class="p">$180</div><span class="small">-25%</span><a class="btn" href="/login">Login</a></div>
  </div>
</section>

<footer class="footer">
  <div class="row small">
    <div>© <span id="yr"></span> Arbexa Profit Finder.</div>
    <div>Made for spot arbitrage enthusiasts worldwide.</div>
  </div>
</footer>
...
xr.open('GET','/ex-logos'); xr.onload=()=>{
 try{
  const d=JSON.parse(xr.responseText||'{}'); const it=d.items||[];
  const wrap=qs('#logos'); if(!wrap) return;
  wrap.innerHTML='';
  for(const x of it){
    const a=document.createElement('a'); a.href=x.href; a.target='_blank'; a.rel='noopener';
    a.className='logo';
    a.innerHTML='<img alt=\"'+(x.name||'')+'\" src=\"'+x.icon+'\"/><div class=\"name\">'+(x.name||'')+'</div>';
    wrap.appendChild(a);
  }
 }catch(_){}
};
xr.send();
window.addEventListener('DOMContentLoaded',()=>{ try{qs('#yr').textContent=String(new Date().getFullYear());}catch(_){}});
        ...
        <div class="menu-panel">
          ...
          <details id="socialsDD" class="group" open>
            ...
            <div class="menu-list">
              ...
              <a href="https://t.me/Arbexaprofitfinderchannel" target="_blank" rel="noopener"><img src="https://telegram.org/favicon.ico" alt=""> Telegram Channel</a>
              <a href="https://t.me/Arbexaprofitfinderchat" target="_blank" rel="noopener"><img src="https://telegram.org/favicon.ico" alt=""> Telegram Chat</a>
